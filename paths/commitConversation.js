...
router.put('/', (req, resp)=>{ 
  ...
  var repo = 'conversations';
  var conversationId = req.params.conversationId;

  var conversation_sql = "SELECT * FROM conversations WHERE slug = " + connection.escape(conversationId);  
  connection.query(conversation_sql, function (error, results, fields) {  
     
    var conversation = JSON.parse(results[0].conversation);
    
    // BEGIN PULL FILE
    var changes_sql = "SELECT DISTINCT file FROM conversation_changes WHERE conversationId = '" + conversationId + "' AND committed = 0";    
    ...
    client.send(command).then(
      (data) => { 
        ...
        streamToString(data.Body).then(
          ...
          var path = '/repos/' + organization + '/conversations/contents/_' + file;
                    ...
                    fetch(github_url,options)
                      .then(function(response) {
                          ...
                          response.json().then(function(data) {   
                            ...
                            var update_changes = "UPDATE conversation_changes SET committed = 1 WHERE conversationId = '" + conversationId + "' AND file = '" + file + "'";
                            connection.query(update_changes, function (error, changes_results, fields) { 
                              ...
                              connection.query(changes_sql, function (error, changes, fields) { 
                                ...
                                // BEGIN PULL FILE
                                var changes_sql = "SELECT * FROM conversation_changes WHERE conversationId = '" + conversationId + "' AND committed = 1";
                                connection.query(changes_sql, function (error, changes, fields) { 
                                  ...
                                  fetch(github_url,options)
                                    .then(function(response) {
                                        ...
                                        response.json().then(function(data) {                                      
                                          ...
                                          var update_changes = "UPDATE conversations SET changes = 0 WHERE slug = " + connection.escape(conversationId);  
                                          connection.query(update_changes, function (error, changes_results, fields) { 

                                            // BEGIN UPDATE CONTRACTS
                                            var update_changes = "DELETE FROM conversation_changes WHERE conversationId = '" + conversationId + "'";
                                            connection.query(update_changes, function (error, changes_results, fields) { 
