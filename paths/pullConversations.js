...
router.get('/', (req, resp)=>{ 
  ...
  for (let i = 0; i < process_conversations.length; i++) {
    if(process_conversations[i].processed == 0 && processed_one == 0){
      ...
      conversations_sql += "(" + connection.escape(conversation.title) + "," + connection.escape(conversation.description) + "," + connection.escape(conversation.slug) + "," + connection.escape(conversations_tags) + "," + connection.escape(conversation.date) + "," + connection.escape(conversation.guestName) + "," + connection.escape(conversation.guestRole) + "," + connection.escape(conversation.guestCompany) + "," + connection.escape(conversation.guestIndustry) + "," + connection.escape(conversation.guestImage) + "," + connection.escape(conversation.bio) + "," + connection.escape(conversation.obfuscated) + "," + connection.escape(conversation.summary) + "," + connection.escape(conversation.subtitle) + "," + connection.escape(conversation.audio_file) + "," + connection.escape(conversation.audio_length) + "," + connection.escape(conversation.youtubeId) + "," + connection.escape(conversation.sound_cloud) + "," + connection.escape(conversation.duration) + "," + connection.escape(conversation.publish_date) + "," + connection.escape(conversation.url) + "," + connection.escape(JSON.stringify(conversation)) + ")";
